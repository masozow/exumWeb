    ...
    (function () {
        ...
        $(document).ready(function () {
            ...
            $("#clients").owlCarousel({
                ...
                paginationSpeed: 400,
                autoHeight: true,
                itemsCustom: [[0, 1], [450, 2], [600, 2], [700, 2], [1000, 4], [1200, 5], [1400, 5], [1600, 5]]
            });
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(1)(module)))
	...
	methods: {
		...
		enviarEmail: function enviarEmail() {
			...
			if (this.validarFormulario()) {
				axios.post(url, this.correo).then(function (response) {
					_this.correo = { 'remitenteCorreo': '', 'remitenteNombre': '', 'mensaje': '' };
					_this.errors = [];
